...
import { completeFactCheck } from "../facts";
import { buildRuleBasedFactCheck } from "../helpers";
import type { FactCheckerResult } from "../contract/prompt";
...
export const checkStepFacts = async (
    ...
    // 遗留：runPerStepFactChecks（plan-executor）仍可能走到；主路径 list 工人不经 checkStepFacts。
    if (isList) {
        const passed =
