...
import { chunkMetadataSchema, inferCorpusDocKind } from "@fambrain/corpus";
...
export const splitMarkdownToDocuments = (
    corpusUserId: string,
    repoPath: string,
    body: string,
    fileName: string
    ...
    const docKind = inferCorpusDocKind(repoPath, trimmed);
